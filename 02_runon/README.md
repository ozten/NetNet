...
Our NetNet foundation model is has a very limited context.
Given an initial prompt, we generate a long-form response
by iteratively calling the model with the previous response.
...
Input: `When I mix blue paint with yellow, I get`

Output:

```
When I mix blue paint with yellow, I get the green, and I have a solid paint.
It is a yellow, yellowish or a yellowish colour. It is a yellowish colour with a somewhat light colour of yellow. It is immortal as a dark colour with many colours for its face.
Impact of short-term memory loss for patients with Alzheimer’s disease, according to new research from the US National Institutes of Health.
